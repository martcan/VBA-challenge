...
'row_number is the ordinal number of row where we want to export the output, it starts as 2
row_number = 2
...
stock_volume = stock_volume + ws.Cells(i, 7).Value
 ...
 'to compare if the next row has the different ticker. If so, that would be the last addition to stock_volume, the closing_price would be the year-end closing price
